...
\begin{verbatim}unique_decoding.py/get_security_levels_for_regime()\end{verbatim}

\subsubsection{RBR soundness in JBR}\label{ sec:fri-rbr-jbr}

\begin{verbatim}johnson_bound.py/get_security_levels_for_regime()\end{verbatim}
